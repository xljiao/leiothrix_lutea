library(geosphere)
library(Cairo)
setwd("C:/Users/jiao/OneDrive/leiothrix lutea/paper1/IBD_IBE_IBR")
setwd("C:/Users/jiaox/Desktop/IBD_IBE_IBR")

#calculate the distance of two sites using geographical coordinates
#https://blog.csdn.net/weixin_34144848/article/details/92013232
...
files <- list.files("C:/Users/jiao/Desktop/maxent_new/current_bio_30s",pattern='asc',
                    full.names=TRUE)
